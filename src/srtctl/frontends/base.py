...
FrontendType = Literal["atomesh", "dynamo", "infera", "sglang", "trtllm_serve", "vllm", "vllm-router"]
...
def get_frontend(frontend_type: str) -> FrontendProtocol:
    ...
    if frontend_type == "atomesh":
    ...
    elif frontend_type == "infera":
        return InferaFrontend()
        ...
        raise ValueError(
            f"Unknown frontend type: {frontend_type!r}. Supported: atomesh, dynamo, infera, sglang, trtllm_serve, vllm, vllm-router"
        )
